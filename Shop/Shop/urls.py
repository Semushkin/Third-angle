...
urlpatterns = [
    ...
    path('s_search_detail/<int:request_id>/', s_search_detail, name='s_search_detail'),
    path('search_detail/<int:request_id>/', search_detail, name='search_detail'),
    path('search_create/', search_create, name='search_create'),
    path('search_list/', search_list, name='search_list'),
    path('new_detail/<int:new_id>/', new_detail, name='new_detail'),
    path('product_detail/<str:book_id>/', product_detail, name='product_detail'),
    ...
    path('product_edit/<str:book_id>/', product_edit, name='product_edit'),
    path('product_delete/<str:book_id>/', product_delete, name='product_delete'),
